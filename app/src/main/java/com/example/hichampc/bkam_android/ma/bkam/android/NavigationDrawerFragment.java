...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new BKAMAdapter(getActivity(), getData());
    ...
    public List<Information> getData() {
        ...
        int[] icons = {R.drawable.home, R.drawable.bkam_logo, R.drawable.monetaire,
                R.drawable.supervision, R.drawable.paiement, R.drawable.billet, R.drawable.billet, R.drawable.billet};
